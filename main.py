...
def connect_db():
    ...
    cursor020.execute(
        '''CREATE TABLE IF NOT EXISTS chtoto(ID INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR(100), years_old INTEGER, gender VARCHAR(100), firstname VARCHAR(100), login VARCHAR(100), password VARCHAR(100))''')
